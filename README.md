...
**Flutter Swiper** | The best swiper(carousel) for flutter, with multiple layouts, infinite loop. Compatible with Android & iOS. | [link](https://pub.dev/packages/flutter_swiper)
...
**Flutter Local Notifications** | A cross platform plugin for displaying and scheduling local notifications for Flutter applications with the ability to customise for each platform. | [link](https://pub.dev/packages/flutter_local_notifications)
**Pull to Refresh** | A widget provided to the flutter scroll component drop-down refresh and pull up load. | [link](https://pub.dev/packages/pull_to_refresh)
**Shimmer** | A package that provides an easy way to add shimmer effect in Flutter project | [link](https://pub.dev/packages/shimmer)
**Barcode Scanner** | A flutter plugin for scanning 2D barcodes and QRCodes via camera. | [link](https://pub.dev/packages/barcode_scan)
**QR.Flutter** | QR.Flutter is a Flutter library for simple and fast QR code rendering via a Widget or custom painter. | [link](https://pub.dev/packages/qr_flutter)
**QR** | A QR code generation library for Dart and Flutter. Supports QR code version 1 through 40, error correction and redundancy. | [link](https://pub.dev/packages/qr)
**Local Auth** | Flutter plugin for Android and iOS device authentication sensors such as Fingerprint Reader and Touch ID. | [link](https://pub.dev/packages/local_auth)
**Fluro** | Fluro is a Flutter routing library that adds flexible routing options like wildcards, named parameters and clear route definitions. | [link](https://pub.dev/packages/fluro)
**OneSignal Flutter SDK** | OneSignal is a free push notification service for mobile apps. This plugin makes it easy to integrate your flutter app with OneSignal | [link](https://pub.dev/packages/onesignal_flutter)
**Curved Navigation Bar** | Stunning Animating Curved Shape Navigation Bar. Adjustable color, background color, animation curve, animation duration. | [link](https://pub.dev/packages/curved_navigation_bar)
**Page Transition** | This package gives you beautiful page transitions. | [link](https://pub.dev/packages/page_transition)
**Bloc** | A predictable state management library that helps implement the BLoC (Business Logic Component) design pattern. | [link](https://pub.dev/packages/bloc)
**Flutter Bloc** | Flutter Widgets that make it easy to implement the BLoC (Business Logic Component) design pattern. Built to be used with the bloc state management package. | [link](https://pub.dev/packages/flutter_bloc)
**Bloc Pattern** | Package that helps you implementing BloC Pattern by Dependency Injection in your project. | [link](https://pub.dev/packages/bloc_pattern)
